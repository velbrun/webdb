...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $id = $_POST['id'];
    $existingQuery = mysqli_query($db, "SELECT id FROM jesica WHERE id = '$id'");
    ...
    if (mysqli_num_rows($existingQuery) > 0) {
        ...
        $sql = "INSERT INTO jesica(nis,id,  nama, jenis_kelamin, no_telp, alamat,  berat_badan, tinggi_badan)
